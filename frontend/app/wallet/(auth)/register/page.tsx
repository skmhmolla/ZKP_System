        ...
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-slate-900 border border-white/10 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden">
                ...
                <div className="text-center space-y-4 mb-10">
                    <h1 className="text-4xl font-black text-white italic uppercase tracking-tighter">Wallet <span className="text-emerald-500">Register</span></h1>
                    <p className="text-slate-500 text-[10px] font-bold uppercase tracking-[0.2em]">Initialize your self-custody identity</p>
                </div>
